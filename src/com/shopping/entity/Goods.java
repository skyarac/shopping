...
public class Goods {
	 ...
	 *  gid           INT                       AUTO_INCREMENT,
	    gname         NATIONAL VARCHAR(20)      NOT NULL,
	    gprice        DOUBLE(18, 1)             NOT NULL,
	    gpic          NATIONAL VARCHAR(100)     NOT NULL,
	    gremark       NATIONAL VARCHAR(500)     NOT NULL,
	    gxremark      NATIONAL VARCHAR(1000),
	    gdate         TIMESTAMP(6)             NOT NULL,
	    giscommend    BIT(1)                    DEFAULT 0 NOT NULL,
	    gisopen       BIT(1)                    DEFAULT 0 NOT NULL,
	    cid           INT                       NOT NULL,
	 * */
	private int gid;
