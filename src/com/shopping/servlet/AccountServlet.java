...
public class AccountServlet extends HttpServlet{
	...
	//		System.out.println(request.getRequestURL());
			...
			response.sendRedirect("/shopping/AccountSer?status=getGoodsInfo&cid="+cid);
			...
			response.sendRedirect("/shopping/AccountSer?status=getGoodsInfo&cid="+Integer.parseInt(request.getParameter("cid")));
